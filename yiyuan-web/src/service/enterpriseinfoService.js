...
const group_no = sessionStorage.getItem("groupid");
/**
 * 企业信息及组织架构业务逻辑接口
 * date: 2019-3-18 pm
 * auther: liuchanghai
...
"manage_num","safety_manager","covered_area","established_time","principal","registered_capital","fixed_assets","last_year_turnover","main_products"];
/**
 * 获取企业信息
 */
 ...
 * 更新企业信息
 */
export let updateEnterpriseInfoById = function (company, callback){
    console.log(company);
    let data = {
        user: username,
        form: tbl_group,
