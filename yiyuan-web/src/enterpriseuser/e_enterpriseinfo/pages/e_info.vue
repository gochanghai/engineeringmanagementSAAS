  ...
  <div id="info">
    <div class="content" v-if="isToogle">
      <div class="information">
        <div class="form">
          <label>注册信息</label>
          <el-form label-width="100px" label-position="left" size="small" :model="infoList" style="flex: 1">
            <el-form-item label="企业名称" prop="name">
              <el-input v-model="infoList.name" clearable disabled></el-input>
            </el-form-item>
            <el-form-item label="企业信用代码" prop="name">
      ...
      <div class="information">
        <div class="form" style="width: 100%">
          <label>经营信息</label>
          <el-form label-width="100px" label-position="left" size="small" ref="form2" :model="form2" :rules="rules2" style="flex: 1">
            <el-form-item label="经营信息" prop="business_type">
              <el-checkbox-group v-model="form2.business_type">
      ...
      <div style="display: flex;width: 280px;margin: 8px auto;">
        <el-button size="medium" class="close" @click="cancel">取 消</el-button>
    ...
    <div class="content" v-else>
      <div class="information">
        ...
        <div class="form">
          <label>管理信息</label>
          <el-form label-width="110px" label-position="left" size="small" :model="infoList" style="flex: 1">
      ...
      <div class="information">
        <div class="form" style="width: 100%">
          <label>经营信息</label>
          <el-form label-width="110" label-position="left" size="small" :model="infoList" style="flex: 1">
      ...
      <div style="display: flex;width: 280px;margin: 8px auto;">
        <el-button class="edit" size="medium" @click="edit">编 辑</el-button>
      </div>
    </div>
    <div class="QR-code">
      <div class="info">
        <img src="../../../common/images/code_line.png" class="img1">
        <img :src="qrcodeUrl" width="106" height="102" class="img2">
      </div>
