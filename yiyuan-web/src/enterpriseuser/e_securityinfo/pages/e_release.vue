<template>
  <div id="e_release">
    <div class="list">
      <div class="title">
        <span>我发布的安全信息</span>
        <el-button size="small" style="background-color:#007ED7;color:#fff" class="release" @click="isVisible=true">发布</el-button>
      </div>
      <div class="data-list">
        <div class="for-item" v-for="(item,index) in listInfo" :key="index" @click="findDetail(item.rel_no)">
    ...
    <release-edit :isVisible="isVisible" @close="isVisible=false" @clickName="getListData"></release-edit>
  </div>
</template>
<script>
