  ...
  <div id="monitor">
    ...
    <div class="tabelData">
      <el-table :data="List">
        ...
        <el-table-column prop="account" label="告警名称">
        </el-table-column>
        <el-table-column prop="cellphone" label="危险源">
        </el-table-column>
        <el-table-column prop="idcard" label="告警时间">
        </el-table-column>
        <el-table-column prop="loginat" label="告警范围（最小）">
        </el-table-column>
        <el-table-column prop="position" label="告警范围（最大）">
        </el-table-column>
        <el-table-column prop="position" label="告警值">
        </el-table-column>
...
<style>
#monitor .search /deep/.el-input__inner {
  border: 1px solid #ccc !important;
  border-radius: 0;
  border-right: none;
}

#monitor .search /deep/.el-button {
