 ...
 * code 服务器返回的结果;
 */
export let fileUpload = function(fileInfo = {
  projectid: null,
  belongidlist: null,
  file: null,
  filename: null,
 ...
 */
export let fileGetPath = function(fileInfo = {
  formname: null,
  formobjid: null,
  fileid: null,
  filename: null
 ...
 * bfileList 返回的实体类数据；
 **/
export let getFileList = function(fileInfo = {
  projectid: null,
  formname: null,
  belongidlist: null,
  filebelong: null
...
export let getFileListByTime = function(date, callback) {
  ...
  let datalist = {
    ...
    fields: {
      ...
      contract: ["projectAbbreviation"],
      default: ["CONCAT(" + date + ") AS releaseuearmonth"]
    },
    join: [{
      dc_mng_file_forms: "projectid",
      contract: "projectid"
 ...
 * fileInfo 实体类数据；
 */
export let previewFile = function(fileInfo = {
  fileName: null,
  filePath: null,
  fileType: null
}) {
